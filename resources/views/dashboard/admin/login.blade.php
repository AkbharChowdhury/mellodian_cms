...
@section('content')
    <div class="container">
        ...
        <form class="row g-3 needs-validation" action="{{ route('admin.check') }}" method="post" novalidate>
            @csrf
            <div class="col-md-8">
            ...
            <div class="col-12">
                ...
                <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="{{ route('admin.register') }}" class="link-success">create an admin account</a></p>
                <small class="text-muted">Please note that you must enter the admin password to register an account as the admin</small>
